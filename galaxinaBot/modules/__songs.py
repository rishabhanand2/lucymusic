...
from galaxinaBot import pbot as Jebot
from galaxinaBot.pyrogramee.dark import get_arg
...
@galaxina.on_message(filters.command("deezer"))
...
import aiohttp
from pyrogram import filters
from galaxinaBot import pbot as ASUNA
