...
import galaxinaBot.modules.sql.notes_sql as sql
from galaxinaBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from galaxinaBot.__main__ import DATA_IMPORT
from galaxinaBot.modules.helper_funcs.chat_status import user_admin
from galaxinaBot.modules.helper_funcs.alternate import typing_action

# from galaxinaBot.modules.rules import get_rules
import galaxinaBot.modules.sql.rules_sql as rulessql

# from galaxinaBot.modules.sql import warns_sql as warnssql
import galaxinaBot.modules.sql.blacklist_sql as blacklistsql
from galaxinaBot.modules.sql import disable_sql as disabledsql

# from galaxinaBot.modules.sql import cust_filters_sql as filtersql
# import galaxinaBot.modules.sql.welcome_sql as welcsql
import galaxinaBot.modules.sql.locks_sql as locksql
from galaxinaBot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("galaxinaBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("galaxinaBot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `galaxinaBot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("galaxinaBot{}.backup".format(chat_id))  # Cleaning file
