...
import galaxinaBot.modules.sql.global_bans_sql as gban_sql
import galaxinaBot.modules.sql.users_sql as user_sql
from galaxinaBot import DEV_USERS, OWNER_ID, dispatcher
