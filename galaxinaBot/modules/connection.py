...
import galaxinaBot.modules.sql.connection_sql as sql
from galaxinaBot import dispatcher, DRAGONS, DEV_USERS
from galaxinaBot.modules.helper_funcs import chat_status
