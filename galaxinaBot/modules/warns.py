...
import telegram
from galaxinaBot import TIGERS, WOLVES, dispatcher
from galaxinaBot.modules.disable import DisableAbleCommandHandler
from galaxinaBot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from galaxinaBot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from galaxinaBot.modules.helper_funcs.string_handling import split_quotes
from galaxinaBot.modules.log_channel import loggable
from galaxinaBot.modules.sql import warns_sql as sql
